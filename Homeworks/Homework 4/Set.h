...
template <typename ItemType>
void difference(const Set<ItemType>& s1, const Set<ItemType>& s2, Set<ItemType>& result);
...
template <typename ItemType>
typename Set<ItemType>::Node* Set<ItemType>::findFirstAtMost(const ItemType& value) const
{
